		...
		<aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="add_plan.php" class="menu-toggle">
                            <i class="material-icons">home</i>
                            <span>Add Plan</span>
                        </a>
                    </li>
					...
					<li>
                        <a href="contact_people.php" class="menu-toggle">
                            <i class="material-icons">home</i>
                            <span>Contacted People</span>
                        </a>
                    </li>
					<li>
                        <a href="show_comment.php" class="menu-toggle">
                            <i class="material-icons">home</i>
                            <span>Comments</span>
                        </a>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; Site Admin<a href="javascript:void(0);">Sainath palanwar</a>.
                </div>
                <div class="version">
                    <b>Contact: </b> +918381099576
                </div>
            </div>
            <!-- #Footer -->
        </aside>